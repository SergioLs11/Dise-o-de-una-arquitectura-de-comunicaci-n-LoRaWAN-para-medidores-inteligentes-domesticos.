...
De la misma manera, se encuentra la carpeta con los resultados de estas pruebas, las cuales son presentadas en hojas de calculo, e simportante tener en cuenta que para el correcto funcionamiento de los códigos para el análisis, estos deben estar en la misma carpeta(o se debe modificar la ruta). 

Y por último se encuentra el diagrama con la planeación del proyecto, en la carpeta Planeación encontrará el diagrama de Gantt con cad auna de las gfases de este. Se recomienda la descraga de este archivo para su correcta visualización.
